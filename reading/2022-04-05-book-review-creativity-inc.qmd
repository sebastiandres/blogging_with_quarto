...
description: "Sobre cómo poder crear un ambiente de trabajo donde pueda flocerer la (elusiva) creatividad"
description-en: "On how to create a work environment where (elusive) creativity can flourish"
date: "2022-04-05"
author: Ed Catmull
genre: No ficción
rating: 8
...
## Comment
A very good book, although I think it doesn't talk so much about creativity itself, but rather about how to create a work environment where (elusive) creativity can flourish. I really enjoyed learning more about the history of the Pixar movies, from when they were concepts and bad ideas, and how the process works by which they are transformed into great stories. The art of storytelling, once again, is one of the things I love and would like to learn more about. The history of Pixar, which overflows with success and creativity, has been a process of effort and learning many times close to failure.

## Top 3 lessons

**Metaphors for what it is to run a company:**
