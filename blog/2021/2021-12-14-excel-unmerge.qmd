...
title-en: "Unmerging excel cells"
description: "Cuando pandas se quedó corto"
description-en: "When pandas fell short"
date: "2021-12-14"
...
![](../_images/2021-12-14-excel-unmerge/ejemplo.png "Ejemplo del problema")
...
![](../_images/2021-12-14-excel-unmerge/pandas1.png "Pandas se queda corto")

Ingenuamente intenté llenar con fillna y reemplazar los NaNs, pero el resultado no era el desado:

![](../_images/2021-12-14-excel-unmerge/pandas2.png "Pandas no completa correctamente los datos")
...
![](../_images/2021-12-14-excel-unmerge/resultado.png "Excel unmerge")
...
What to do then? After a lot of googling, I found the right solution on [stackoverflow](https://stackoverflow.com/questions/46426662/openpyxl-assign-value-to-range-of-cells-during-unmerge). The `openpyxl` library is incredibly flexible and allows cell-by-cell manipulation.
