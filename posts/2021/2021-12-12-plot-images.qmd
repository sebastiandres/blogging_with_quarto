...
title-en: "Plotting emojis"
description: "Resumen de un googleo interminable"
description-en: "Summary of an endless googling session"
date: "2021-12-12"
categories: [código]
categories-en: [code]
---
...
Recently I needed to combine a line chart with an emoji. I googled until exhaustion,
but the solutions didn't work correctly for me. After trying tons of options,
the code that did work for me was the following:
